  ...
  return (
    <footer className="footer bg-neutral text-neutral-content p-10">
      <aside>
        ...
        <p>
          Perdrix Industries Ltd.
          <br />
          Providing fun games since 1988
        </p>
      </aside>
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          ...
          <a href="https://www.youtube.com/hashtag/skyjo">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="https://www.facebook.com/magilanogames/?locale=fr_FR">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
